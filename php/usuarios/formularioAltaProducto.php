...
<head>
	...
	<!-- Title Tag  -->
    <title>Alta de Producto (CUSTOM)</title>
	<!-- Favicon -->
...
3 : Cajero
                                    ...
                                    <span>
                                        <strong>
                                            <?php
                                                echo $_SESSION["nombreCompletoUsuario"];
                                            ?>
                                        </strong>
                                        | <em>
                                            <?php
						...
						<div class="text-inner">
                            ...
                            <div class="">
								<div class="col-lg-7 col-12">
									<!-- <div class="hero-text"> -->
                                    <div class="">
										<h1><span>Alta de Producto</span></h1>
                                        ...
                                        <!--INI: Formulario registrar Producto -->
                                        <form action="registrar_producto.php" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="id_nombre_prod">Nombre del producto: </label>
                                                <input id="id_nombre_prod" type="text" name="nombre_prod" class="form-control" placeholder="Taza sublimado" minlength="5" maxlength="60" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="id_descrip_prod">Descripción del Producto: </label>
                                                <input id="id_descrip_prod" type="text" name="descrip_prod" class="form-control" placeholder="Taza de 410 ml con patrón tipo mármol" minlength="5" maxlength="120"  required>
                                            </div>
                                            <!--INI: imagen del Producto-->
                                            <div class="form-group">
                                                <!-- Img de habitación... -->
                                                <label for="id_image_file_prod">Imagen del Producto: </label>
                                                <input id="id_image_file_prod" type="file" name="imagen_producto" required>
                                            </div>
                                            <!--FIN: imagen del Producto-->
                                            <div class="form-group">
                                                <label for="id_precio_venta_publico">Precio de venta (al público): </label>
                                                <input id="id_precio_venta_publico" type="number" name="precio_venta_publico" class="form-control" placeholder="5.50" min="0.50" max="600" step="0.50" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="id_existencia_ini">Existencia (INICIAL): </label>
                                                <input id="id_existencia_ini" type="number" name="existencia_ini" class="form-control" placeholder="1" min="1" max="2000" step="1" required>
                                            </div>
                                            
											<div class="form-group">
                                                <label for="id_codigo_barras">Código de barras: </label>
                                                <input id="id_codigo_barras" type="number" name="codigo_barras" class="form-control" placeholder="6924247440990" min="1" max="9999999999999" step="1" required>
                                            </div>

                                           <!--INI: select de CATEGORÍA de PRODUCTO -->
                                           <div class="form-group">
                                                <label for="id_categoria_prod">CATEGORÍA: </label>
                                                <select id="id_categoria_prod" name="categoria_prod">
                                           ...
                                           <!--FIN: select de CATEGORÍA de PRODUCTO -->

                                           <!--TODO :: implementar LÓGICA de JS para campos adicionales (mostrar / ocultar) -->


										   <!-- INI (campo DINÁMICO) :: Capacidad (ml) :: TAZA -->
                                            <div id="div_capacidad" class="form-group">
                                                <label for="id_capacidad_ml">Capacidad (en ml): </label>
                                                <input id="id_capacidad_ml" type="number" name="capacidad_ml" class="form-control" placeholder="100" min="1" max="3000" step="1">
                                            </div>
											<!-- FIN :: Capacidad (ml) :: TAZA -->

											<!-- INI (campo DINÁMICO) :: Tipo de TAZA -->
											<div id="div_tipo_taza" class="form-group">
                                                <label for="id_tipo_taza">Tipo (taza): </label>
                                                <select id="id_tipo_taza" name="tipo_taza">
                                                    <option value="Normal" selected>Taza Normal</option>
                                                    <option value="Mágica">Taza Mágica</option>
                                                </select>
                                            </div>
											<!-- FIN :: Tipo de TAZA -->
											...
											<!--
                                            <div class="form-group">
                                                <label for="id_caract_ad">Características Adicionales: </label>
                                                <textarea id="id_caract_ad" name="caracter_ad" cols="18" rows="8" class="form-control" placeholder="La habitación cuenta con cocineta, jacuzzi, sala, etc.">

                                                </textarea>
                                            </div>
											-->

											<!-- INI :: (Campos DINÁMICOS) -->
											<div id="div_talla" class="form-group" style="display: none">
                                                <label for="id_talla">Talla: </label>
                                                <select id="id_talla" name="talla">
											...
											<div id="div_color" class="form-group" style="display: none">
                                                ...
                                                <input id="id_color" type="color" name="color" class="form-control">
                                            </div>
                                            ...
                                            <input type="submit" class="btn btn-success btn-block" name="registrar_habitacion" value="Registrar PRODUCTO">

                                        </form>
                                        <!--FIN: Formulario regsitrar Producto -->
